...
- item_bank:
  ...
  A data frame of item metadata including item parameters and related
  information.
...
- cut_score:
  ...
  MST stages. Each vector represents the cut scores used to determine
  module transitions for a particular stage.
...
contains 8 dichotomously scored items calibrated under the IRT
